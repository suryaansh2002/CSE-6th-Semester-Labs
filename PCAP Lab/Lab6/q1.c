...
int main(void)
{
    ...
    ret = clEnqueueWriteBuffer(command_queue, n_mem_obj, CL_TRUE, 0, sizeof(int), &len, 0, NULL, NULL);
    ...
    ret = clSetKernelArg(kernel, 1, sizeof(cl_mem), (void *)&n_mem_obj);
